...
<head>
    ...
    <title>Gerenciador UBS | Solicitações</title>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="active">
                    <a href="#"><i class="fa fa-th"></i> <span>Gerenciar Solicitações</span></a>
                </li>
                <li>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Solicitações não avaliadas</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    <td>${solicitacoes.usuarioSolicitante.nomeUsuario}</td>
                                    <td>${solicitacoes.setorSolicitante.nomeSetor}</td>
                                    <td>${solicitacoes.dataSolicitacao}</td>
                                    <td><a href="detalhesSolicitacao?id=${solicitacoes.id}" type="button" class="btn btn-info btn-flat">Ver detalhes</a></td>
                                </tr>
                                </c:forEach>
                                </tbody>
                                <tfoot>
