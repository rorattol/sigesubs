...
<head>
    ...
    <title>AdminLTE 2 | Adicionar Usuário</title>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" action="addUsuario" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="nameInput">Nome do Usuário</label>
                                    <input type="text" class="form-control" id="nameInput" name="nomeUsuario" placeholder="Nome do Usuário">
                                </div>
                                <div class="form-group">
                                    <label for="inputEmail">Login</label>
                                    <input type="email" class="form-control" id="inputEmail" name="loginUsuario" placeholder="Login">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="idSetor" style="width: 100%;" required>
                                        <c:forEach var="unidade" items="${unidades}">
                                            <option value="${unidade.idSetor}">${unidade.nomeSetor}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="inputSenha">Senha</label>
                                    <input type="password" class="form-control" id="inputSenha" name="senhaUsuario" placeholder="Senha">
                                </div>
                                <div class="form-group">
                                    <label for="inputSenha2">Digite sua senha novamente</label>
